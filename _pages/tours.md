...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    const choices = {
      ...
      europe: {
        title: "先看法国与欧洲跨国长线",
        text: "如果你想以法国为主线，再连接瑞士、意大利或西班牙，可以先看法国与欧洲长线。现在已上线法意瑞经典环线，适合有10天以上假期、希望一次体验巴黎、瑞士雪山、意大利湖区和南法海岸的家庭、情侣或朋友小团。",
...
{% if site.enable_project_categories and page.display_categories %}
  ...
  <div class="mb-4">
    <p>如果你的假期比较充裕，想把巴黎、南法，或法国周边的瑞士、意大利、西班牙一起安排，可以先看这一组精选路线。这里既有适合第一次深度玩法国的10天路线，也有以法国为核心、继续延伸到周边国家的欧洲跨国长线。</p>
    <p>长线旅行的美，在于同一次旅程里可以遇见不同的欧洲：巴黎的城市与艺术，南法的阳光与海岸，瑞士的湖泊与雪山，意大利或西班牙的建筑和生活气息。但路线不宜只看城市数量，更要看进出机场、停留节奏、酒店更换和每日移动是否合适。</p>
    <p>法国10天更适合第一次来法国、想从巴黎一路玩到普罗旺斯和蔚蓝海岸的客人；法意瑞经典环线更适合假期更长，想把法国、瑞士和意大利连成一趟从容旅程的家庭、情侣或朋友小团。如果你还拿不准，可以先把人数、月份、天数和想去的城市发给我，我会帮你判断哪条路线更适合。</p>
  </div>

...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    const choices = {
      ...
      europe: {
        title: "先看法国与欧洲跨国长线",
        text: "如果你想把不止一个国家放进同一次假期，可以先看法国与欧洲长线。想看巴黎、瑞士雪山和意大利湖区，选法意瑞；想从巴塞罗那一路进入普罗旺斯和蔚蓝海岸，选法国西班牙；想从罗马、托斯卡纳、五渔村一路走到尼斯和马赛，选法国意大利。",
        note: "比较适合：假期比较完整，想跨国旅行，也希望有人把交通、住宿、进出城市和每日节奏安排好。",
        href: "#法国与欧洲长线",
        label: "查看跨国长线"
      },
      paris: {
...
{% if site.enable_project_categories and page.display_categories %}
  ...
  <div class="mb-4">
    <p>如果你的假期比较完整，想把法国和周边国家放进同一趟旅行，可以先看这一组精选路线。它适合不想只停留在一个城市，也希望有人把跨国交通、住宿和每日节奏安排好的客人。</p>
    <p>长线旅行的美，是一次遇见不同的欧洲：巴黎的艺术，南法的阳光，瑞士的雪山，意大利的古城与海岸，西班牙的建筑和地中海气息。真正舒服的路线，不是国家越多越好，而是每一段都衔接自然，每天都有时间好好感受。</p>
    <p>第一次深度玩法国，可以看法国10天；想看法国、瑞士和意大利湖区，可以看法意瑞；从巴塞罗那接南法，可以看法国西班牙；向往罗马、托斯卡纳、五渔村和南法海岸，可以看法国意大利。如果还拿不准，把人数、月份、天数和想去的城市发给我，我可以先帮你判断哪条路线更适合。</p>
  </div>

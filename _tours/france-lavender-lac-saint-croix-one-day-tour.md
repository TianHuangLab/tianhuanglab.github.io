  ...
  <div class="card-list">
    ...
    <div class="card" data-points='[{"lat":43.2965,"lng":5.3698,"name":"马赛","desc":"法国第二大城市，地中海重要港口"}]'>
      ...
      <div class="card-content">
        清晨从马赛出发，沿途欣赏普罗旺斯田园风光，开启浪漫一日游。
      </div>
    </div>

    <!-- 瓦伦索勒薰衣草田 -->
    <div class="card" data-points='[{"lat":43.8375,"lng":5.9833,"name":"瓦伦索勒","desc":"著名的薰衣草花田聚集地"}]'>
      <div class="card-title">
        <h3>瓦伦索勒：梦幻紫色花海</h3>
      </div>
      <div class="card-content">
        沉浸于6-7月盛放的薰衣草田中，拍摄最浪漫的南法旅行照片，嗅闻空气中弥漫的芳香。
      </div>
    </div>

    <!-- 穆斯捷陶瓷小镇 -->
    <div class="card" data-points='[{"lat":43.8454,"lng":6.2215,"name":"穆斯捷-圣玛丽","desc":"“法国最美村庄”之一，以陶瓷闻名"}]'>
      <div class="card-title">
        <h3>穆斯捷圣玛丽：悬崖上的陶艺村</h3>
      </div>
      <div class="card-content">
        漫步于山间小镇，探索手工陶艺小店，感受传统与自然的完美融合。
      </div>
    </div>

    <!-- 圣十字湖 -->
    <div class="card" data-points='[{"lat":43.7787,"lng":6.2047,"name":"圣十字湖","desc":"碧蓝湖泊与峡谷美景"}]'>
      <div class="card-title">
        <h3>圣十字湖：湖光山色的终章</h3>
      </div>
      <div class="card-content">
        在宝石蓝湖泊边自由漫游，可选择皮划艇或徒步，沉浸在南法自然的壮丽与宁静中。
      </div>
    </div>
  </div>
...
const waypoints = [
  ...
  { lat: 43.8375, lng: 5.9833, name: "瓦伦索勒", desc: "著名的薰衣草花田聚集地" },
  { lat: 43.8454, lng: 6.2215, name: "穆斯捷-圣玛丽", desc: "悬崖上的童话村庄，以陶瓷闻名" },
  { lat: 43.7787, lng: 6.2047, name: "圣十字湖", desc: "碧蓝湖泊与峡谷美景" }
];
